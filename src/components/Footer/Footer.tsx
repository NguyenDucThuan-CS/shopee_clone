    ...
    <div className='max-w-7xl mx-auto px-4'>
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
        <div className='lg:col-span-1'>
          <div>20022 Shoppee. Tất cả các quyền được bảo lưu</div>
        </div>
      ...
      <div className='text-center text-sm mt-10'>
        ...
        <div className='mt-2'>
          Địa chỉ: Tầng 4-5-2, Tòa nhà Capital Place, số 29 đường Liễu Giai, Phường Ngọc Khánh, Quận Ba Đình, Thành phố
